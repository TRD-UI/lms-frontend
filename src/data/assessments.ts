...
export const assessments: Assessment[] = [
    ...
    // ─── Course 14 · Cybersecurity — long-form paper ───────────────────
    // Thirty questions, deliberately, so the quiz navigator is exercised at a
    // realistic exam length rather than the four-question happy path.
    {
        id: "as-18",
        courseId: "14",
        title: "Cybersecurity Final Examination",
        description:
            "The full end-of-course paper. Thirty questions across networking, cryptography, threats and secure design.",
        kind: "final",
        status: "published",
        passingScore: 70,
        timeLimitMinutes: 45,
        ...
        questions: [
            q("as-18-q1", "Which layer of the OSI model does TCP operate at?", ["Network", "Transport", "Session", "Data link"], 1, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q2", "What is the default port for HTTPS?", ["80", "443", "8080", "22"], 1, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q3", "Which encryption standard is considered strongest here?", ["DES", "3DES", "AES-256", "RC4"], 2, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q4", "A firewall's primary purpose is to filter network traffic.", ["True", "False"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q5", "What does CIA stand for in security?", ["Confidentiality, Integrity, Availability", "Control, Identity, Access", "Cipher, Integrity, Audit", "Confidentiality, Identity, Authorisation"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q6", "Which of these is a symmetric cipher?", ["RSA", "AES", "ECDSA", "Diffie-Hellman"], 1, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q7", "Phishing primarily exploits which weakness?", ["Buffer overflows", "Human judgement", "Weak ciphers", "Open ports"], 1, { difficulty: "hard", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q8", "What does a salt protect against?", ["Brute force", "Rainbow tables", "Packet sniffing", "SQL injection"], 1, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q9", "Which HTTP header enforces transport security?", ["X-Frame-Options", "Strict-Transport-Security", "Content-Type", "Accept-Encoding"], 1, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q10", "Select every valid authentication factor.", ["Something you know", "Something you have", "Something you are", "Something you want"], [0, 1, 2], { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q11", "What is privilege escalation?", ["Gaining higher access than granted", "Resetting a password", "Encrypting a disk", "Rotating a key"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q12", "A VPN guarantees anonymity from all parties.", ["True", "False"], 1, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q13", "Which tool captures network packets?", ["Wireshark", "Photoshop", "Postman", "Figma"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q14", "What does SQL injection target?", ["The database query layer", "The CSS renderer", "The DNS resolver", "The file system"], 0, { difficulty: "hard", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q15", "Which is a denial-of-service indicator?", ["Sudden traffic flood", "Slow typing", "Low disk space", "Expired cookie"], 0, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q16", "What is the purpose of a WAF?", ["Filter web application traffic", "Compress images", "Cache DNS", "Balance CPU load"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q17", "Two-factor authentication requires two of the same factor type.", ["True", "False"], 1, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q18", "Which describes a zero-day?", ["A patched bug", "A vulnerability with no patch yet", "An expired certificate", "A retired protocol"], 1, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q19", "What does hashing provide?", ["Reversible transformation", "One-way fingerprint", "Compression", "Encoding"], 1, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q20", "Select every common malware category.", ["Ransomware", "Spyware", "Worm", "Firewall"], [0, 1, 2], { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q21", "Which protocol secures email in transit?", ["SMTP", "STARTTLS", "POP3", "IMAP"], 1, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q22", "What is lateral movement?", ["Spreading across systems post-compromise", "Rebooting a server", "Rotating logs", "Scaling horizontally"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q23", "A certificate authority's role is to vouch for identity.", ["True", "False"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q24", "Which is a secure password practice?", ["Reuse across sites", "Long unique passphrases", "Write on a sticky note", "Share with the team"], 1, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q25", "What does IDS stand for?", ["Intrusion Detection System", "Internal Data Store", "Identity Directory Service", "Integrated Defence Suite"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q26", "Which reduces the blast radius of a breach?", ["Flat networks", "Network segmentation", "Shared credentials", "Disabled logging"], 1, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q27", "What is social engineering?", ["Manipulating people to gain access", "Refactoring code", "Tuning a database", "Designing a network"], 0, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q28", "Select every principle of secure design.", ["Least privilege", "Defence in depth", "Fail securely", "Security through obscurity"], [0, 1, 2], { difficulty: "hard", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q29", "Which log is most useful after a breach?", ["Audit trail", "Marketing analytics", "Build log", "Changelog"], 0, { difficulty: "medium", tags: ["Security"], remedialModuleId: "14-1" }),
            q("as-18-q30", "Patching is a preventive control.", ["True", "False"], 0, { difficulty: "easy", tags: ["Security"], remedialModuleId: "14-1" }),
        ],
    },
];
